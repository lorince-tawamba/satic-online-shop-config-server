...
- satic-online-shop-config-server-1.0.0

**Create the docker image**

```bash
  docker build -t lorincetawamba/satic-online-shop-config-server:1.0.0 -f Dockerfile .
```
...
```bash
  docker run -d -p 8888:8888 -t lorincetawamba/satic-online-shop-config-server:1.0.0
```
...
```bash
  docker image push lorincetawamba/satic-online-shop-config-server:1.0.0
```
